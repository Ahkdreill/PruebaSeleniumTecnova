    ...
    public class BaseStep
    {
        ...
        public static void SetUp()
        {
            try
            {
                ...
                htmlReporter.Config.ReportName = "Automatización de Pruebas Tecnova";
                htmlReporter.Config.EnableTimeline = false;

                extent = new ExtentReports();

                extent.AddSystemInfo("Sistema", "Trello.com");
                extent.AddSystemInfo("Ambiente", "Producción");
