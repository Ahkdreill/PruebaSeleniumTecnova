...
namespace CL.Tecnova.Automation.Trello.Definition
{
    public class BasePage
    {
        ...
        {
            string ConnectionString = string.Empty; // ParametrosEjecucion.CadenaConexionBD;
        ...
        /// <summary>
        /// Valida si el elemento web es visible.
        /// </summary>
        /// <param name="elemento">Elemento web.</param>
        /// <returns>Retorna Driver, bool</returns>
        public Func<IWebDriver, bool> IsElementVisible(IWebElement elemento)
        {
